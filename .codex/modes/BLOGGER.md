...
- Keep a short list of published posts/URLs inside the staging folder (or the post itself); avoid long-lived documentation artifacts unless explicitly requested.
