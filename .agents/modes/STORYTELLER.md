...
> **Note:** Keep the storyteller cheat sheet in `.agents/notes/storyteller-mode-cheat-sheet.md` and update it with current tone, canon, and reference material. Store lore notes in `.agents/lore/notes/` and long-term outlines or arcs in `.agents/lore/planning/` (create these folders if they do not exist).
...
- Document answers and context in `.agents/lore/notes/` for easy retrieval.
- Outline arcs, release narratives, or unresolved questions in `.agents/lore/planning/`.
