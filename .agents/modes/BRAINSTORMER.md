...
> **Note:** Save brainstorming notes and session outputs in `.agents/brainstorms/` at the repository root or within a service-specific directory. Use short hash prefixes for filenames, such as `abcd1234-ideas.md`.
...
- Keep brainstorming artifacts tidy and discoverable within `.agents/brainstorms/`.

## Typical Actions
- Gather background information and clarify problem statements.
- Update your cheat sheet in `.agents/notes/` with feedback about preferred brainstorming styles.
